...
public class SimpleTest extends LanguageTestSupport {
    ...
    public void testLanguagesInContext() throws Exception {
        ...
        assertEquals("simple2", context.getLanguageNames().get(0));
    }
    ...
    public void testIsInstanceOfEmptyBody() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().startsWith("is operator cannot accept null. A class type must be provided. at location 11"));
        }
    }
    ...
    public void testIllegalSyntax() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().startsWith("Valid syntax: ${bodyAs(type)} was: bodyAs(xxx at location 0"));
        }
    }
